  ...
  return (
    <Layout>
      ...
      >
        ...
        <div className="w-full grow h-full flex flex-col lg:flex-row gap-5 min-h-0">
          {/* Upload Zone - Takes more space on large screens */}
          <div className="grow max-h-full w-full lg:w-4/6 flex flex-row">
            <div
              ref={dropZoneRef}
              className={`w-full h-full relative border border-dashed rounded-xl lg:rounded-2xl cursor-pointer transition-all duration-300 ${
                isDragOver
                  ? "border-amber-500 bg-linear-to-br from-amber-100/80 to-orange-100/80 dark:from-amber-900/30 dark:to-orange-900/30 scale-[1.01] shadow-2xl"
                  : hasImage
            ...
            >
              {!hasImage ? (
                ...
                <div className="w-full h-full flex flex-col justify-center items-center p-6 lg:p-12 bg-linear-to-br from-amber-50/80 via-yellow-50/80 to-orange-50/80 dark:from-amber-900/10 dark:via-yellow-900/10 dark:to-orange-900/10 rounded-2xl lg:rounded-3xl">
                  {/* Main Upload Icon */}
                  <div
                  ...
                  >
                    <div className="relative">
                      <div className="w-24 h-24 sm:w-28 sm:h-28 lg:w-36 lg:h-36 bg-linear-to-br from-amber-400 via-orange-400 to-yellow-500 rounded-3xl lg:rounded-4xl flex items-center justify-center shadow-2xl">
                        <Upload
                          size={40}
                      ...
                      {isDragOver && (
                        <div className="absolute inset-0 bg-linear-to-br from-amber-400 via-orange-400 to-yellow-500 rounded-3xl lg:rounded-4xl flex items-center justify-center animate-pulse">
                          <Sparkles
                            size={40}
                            className="text-white sm:w-12 sm:h-12 lg:w-16 lg:h-16"
                          />
                  ...
                  <div className="flex flex-wrap justify-center gap-3 lg:gap-4">
                    ...
                    <div className="px-4 py-2 lg:px-6 lg:py-3 bg-linear-to-r from-green-100 to-emerald-100 dark:from-green-900/30 dark:to-emerald-900/30 rounded-2xl border border-green-200 dark:border-green-800 shadow-md">
                ...
                <div className="w-full h-full relative bg-linear-to-br from-slate-50 to-gray-100 dark:from-slate-900/50 dark:to-gray-900/50 rounded-2xl lg:rounded-3xl overflow-hidden">
                  {!imageError ? (
                    <>
                      <Image
                      ...
                      {/* Change image button */}
                      <Button
                        className="rounded-full! absolute! top-4! lg:top-6! right-4! lg:right-6 w-10! h-10! lg:w-12! lg:h-12! bg-linear-to-br! from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white! border-0!"
                        type="button"
                        title="Change image"
                        onClick={(e) => {
                          e.stopPropagation();
                    ...
                    <div className="w-full h-full flex flex-col justify-center items-center gap-6 p-6">
                      <div className="w-20 h-20 lg:w-24 lg:h-24 bg-linear-to-br from-red-100 to-red-200 dark:from-red-900/30 dark:to-red-800/30 rounded-3xl flex items-center justify-center shadow-lg">
                        <ImageIcon
                          size={32}
          ...
          <div className="h-full w-full lg:w-2/6 flex flex-col gap-5">
            ...
            {hasImage && (
              <div className="bg-linear-to-br from-white/80 to-amber-50/80 dark:from-black/30 dark:to-amber-900/20 backdrop-blur-sm rounded-xl lg:rounded-2xl p-4 lg:p-5 xl:p-6 shadow-lg border border-amber-200/50 dark:border-amber-800/50">
                <h3 className="text-lg lg:text-xl font-heading font-bold text-amber-700 dark:text-amber-300 mb-4 lg:mb-6">
                  Image Actions
                </h3>
                <div className="flex flex-col gap-y-1">
            ...
            {/* Tips Section */}
            <div className="bg-linear-to-br from-blue-50/80 to-indigo-50/80 dark:from-blue-900/20 dark:to-indigo-900/20 backdrop-blur-sm rounded-xl lg:rounded-2xl p-4 lg:p-5 xl:p-6 shadow-lg border border-blue-200/50 dark:border-blue-800/50">
